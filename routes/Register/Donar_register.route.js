...
const { getDonars, registerDonar , updateDonar , deleteDonar , getSpecificDonarInfo ,  } = require("../../controllers/register/donar_register.controller");
...
router.get('/donars-one', checkAuth, getSpecificDonarInfo );
